...
\begin{enumerate}
  ...
  \item 輸入錯誤答案 $\to$ 顯示「Incorrect CAPTCHA answer. Please try again.」且帳號未被建立
  \item 輸入正確答案 $\to$ 成功註冊並跳轉至 Feed 頁面
\end{enumerate}
影片連結：\textcolor{red}{\texttt{https://youtu.be/xxxxxxxx}}
\end{todobox}
...
\begin{enumerate}
  ...
  \item 選擇一個選項並投票 $\to$ 顯示各選項百分比與已選標記
  \item 嘗試再次投票 $\to$ 顯示「You have already voted on this poll.」
\end{enumerate}
影片連結：\textcolor{red}{\texttt{https://youtu.be/xxxxxxxx}}
\end{todobox}
